...
`${GOPATH}/src/github.com/mathsterk/varnishlogbeat`
...
```
git remote set-url origin https://github.com/mathsterk/varnishlogbeat
...
```
mkdir -p ${GOPATH}/src/github.com/mathsterk/varnishlogbeat
git clone https://github.com/mathsterk/varnishlogbeat ${GOPATH}/src/github.com/mathsterk/varnishlogbeat
```
